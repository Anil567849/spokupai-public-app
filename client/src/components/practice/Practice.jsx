                ...
                <div className={Styles.contentContainer}>
                    {
                        ...
                        <><div className={Styles.phraseContainer}>                                            
                            <div className={Styles.phraseTextContainer}>
                                <Typography>{props.phrase.hindi}</Typography>
                                <img className={Styles.echoButton} onClick={() => sayPhrase(props.phrase.hindi)} src="/audio.png" alt="audio" />
                            </div>
                            {
                                    props.showHint && !props.showPhrase && <Typography sx={{padding: '1rem 0'}}><b>Type: </b>{props.phrase.type}</Typography>
                            }
                            {   
                                props.showPhrase && <> 
                                                {(props.showHint !== undefined) && <Typography sx={{padding: '1rem 0'}}><b>Type: </b>{props.phrase.type}</Typography>}
                                                <div className={Styles.phraseTextContainer}>
